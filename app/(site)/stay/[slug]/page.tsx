    ...
    <>
      ...
      <section className="relative min-h-[520px] h-[65vh] w-full overflow-hidden mt-20 flex flex-col justify-end">
        ...
        <div className="relative container-content pb-16 z-10 max-w-4xl">
          <div className="inline-flex items-center gap-2 mb-4 bg-forest-deep/60 backdrop-blur-md px-3.5 py-1 border border-sand/30">
          ...
          <div className="mt-6 flex flex-wrap items-center gap-6 text-xs tracking-luxury uppercase text-sand-light">
      ...
      <section className="container-content py-20 md:py-28">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-8">
            ...
            {/* Architectural Specifications Row */}
            <div className="mt-12 grid grid-cols-3 gap-6 border-y border-sand/20 py-8 bg-mist/20 px-6">
              <div>
            ...
            <div className="mt-20">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                {room.gallery.map((src, index) => (
                  <div
                    key={src}
                    className="group relative aspect-[4/5] overflow-hidden bg-forest-dark border border-sand/20 shadow-luxury"
                  >
                    <Image
                      src={src}
          ...
          <aside className="lg:col-span-4 sticky top-28">
            <div className="glass-card p-8 border border-sand/30 shadow-luxury-float">
              <div className="flex items-center justify-between pb-5 border-b border-sand/20">
                ...
                <span className="px-3 py-1 bg-sand/20 text-sand-dark text-xs tracking-wide uppercase font-medium">
                  {room.status}
                </span>
              </div>
              ...
              <div className="pt-6">
                <Link
                  ...
                  className="w-full inline-flex items-center justify-center gap-3 py-4 bg-forest text-cream text-xs tracking-luxury uppercase font-medium hover:bg-forest-dark transition-all shadow-md hover:shadow-xl group"
                >
                ...
                <p className="mt-4 text-center text-[11px] text-charcoal/50">
                  Best Rate Guaranteed • No payment required upfront
                </p>
              </div>
